  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (state.succeeded) {
      toast({
        ...
        description: "Zgłoszenie zakupu pojazdu zostało wysłane do doradcy.",
      });
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="border-border">
                <CardHeader>
                  ...
                  <CardDescription>Zgłoszenie zakupu pojazdu zostało wysłane.</CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl font-bold text-foreground mb-4">Zgłoszenie zakupu pojazdu</h1>
              <p className="text-lg text-muted-foreground">Wypełnij formularz i dołącz umowę kupna (zdjęcie / skan).</p>
            </div>

            <Card className="border-border">
              <CardHeader>
                <CardTitle>Zgłoszenie zakupu pojazdu</CardTitle>
                <CardDescription>Wszystkie pola oznaczone * są wymagane</CardDescription>
              </CardHeader>

              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-8" encType="multipart/form-data">
                  <input type="hidden" name="_subject" value="ZGŁOSZENIE ZAKUPU POJAZDU - NOWE ZGŁOSZENIE" />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="purchaseAgreement">SKANY / ZDJĘCIA DOKUMENTÓW *</Label>
                      <Label htmlFor="purchaseAgreement" className="text-sm text-muted-foreground">
                        ZDJĘCIE / SKAN UMOWY KUPNA *
                      </Label>
                      <Input
                        id="purchaseAgreement"
                        name="ZDJĘCIE / SKAN UMOWY KUPNA"
                        type="file"

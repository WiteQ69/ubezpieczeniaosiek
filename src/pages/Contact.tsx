...
const Contact = () => {
  ...
  // ✅ Toast po sukcesie/błędzie (po zmianie state)
  useEffect(() => {
    if (state.succeeded) {
      toast({
      ...
      <main className="flex-1 bg-white pt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          <div className="mb-12 text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-zinc-900 mb-4 tracking-tight">Skontaktuj się z nami</h1>
                ...
                <CardContent className="flex-1">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="phone" name="NUMER TELEFONU" type="tel" required />
                    </div>
                    ...
                    {/* opcjonalnie: mały komunikat pod formularzem */}
                    {state.succeeded ? (
                      <p className="text-sm text-green-600">Wiadomość została wysłana.</p>
                    ) : null}
                  </form>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-6 flex-1">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-600">Kościelna 5, 32-608 Osiek</p>
                    </div>
                  </div>
